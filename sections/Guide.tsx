...
const Guide = () => {
  const projectStructure: Tree = {
    ...
    children: [
      {
        name: "__init__.py",
        description: "Initalizes and provides global variables",
      },
      {
        name: "main.py",
    ...
    <ColumnCard>
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
          ...
          <Typography>
            <strong> 1. </strong> Generate a base FastAPI application using the
            API generator
          </Typography>
          <Typography>
            <strong> 2. </strong> Connect the FastGen application to your newly
            created FastAPI.
            <br />
          ...
          <Typography>
            <strong> 3. </strong> Create entities using the Entity Generator to
            quickly add CRUD routes to your API
          </Typography>
          <Typography>
          ...
          <ul>
            ...
            <li>Automatic form generation (using the FastForm component)</li>
          </ul>
        </Grid>
        <Grid item xs={12} md={6}>
